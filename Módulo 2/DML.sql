...
VALUES (10, 'Kitana', 'Humana', 'Assasina', 85, 3, 90, 10, 55, 80, 'Assassina de 10.000 anos e princesa da Exoterra');
VALUES (20, 'Mileena', 'Humana', 'Assasina', 50, 2, 34, 5, 90, 67, 'Mileena é um clone da princesa Kitana feita por Shang Tsung para Shao Kahn feita para substituir a princesa');
VALUES (30, 'Jade', 'Humana', 'Assasina', 40, 4, 40, 15, 20, 60, 'Jade é amiga de longa data de Kitana, e é uma das assassinas e espiã pessoal de Shao Kahn');
