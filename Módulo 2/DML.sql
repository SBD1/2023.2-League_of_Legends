...
INSERT INTO Itens_de_Tank (id_item, nome_item, nome_area, preco_item, dano_item, vida_adicional)
VALUES
  (2000, 'Escudo Relicári', 'Floresta', 60, 5, 10),
  (8000, 'Escudo de Doran', 'Floresta', 65, 5, 15);

INSERT INTO Itens_de_mago (id_item, nome_item, nome_area, preco_item, dano_item, dano_magico_adicional)
VALUES
  (3000, 'Anel de Doran', 'Floresta', 90, 15, 5),
  (4000, 'Lacre Sombrio', 'Floresta', 90, 15, 5),
  (5000, 'Gume do Ladrão Arcano', 'Floresta', 65, 8, 3);

INSERT INTO Itens_de_lutador (id_item, nome_item, nome_area, preco_item, dano_item, dano_fisico_adicional)
VALUES
  (1000, 'Foice Espectral', 'Floresta', 50, 10, 5),
  (6000, 'Lâmina de Doran', 'Floresta', 65, 8, 5),
  (7000, 'Espada Longa', 'Floresta', 90, 20, 5),
